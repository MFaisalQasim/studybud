...
class User(AbstractUser):
    ...
    avatar = models.ImageField(("avatar"), null=True, default="avatar.svg")
...
class Room(models.Model):
    ...
    host = models.ForeignKey(User, verbose_name=(
        "host"), on_delete=models.SET_NULL, null=True)
    topic = models.ForeignKey(Topic, verbose_name=(
